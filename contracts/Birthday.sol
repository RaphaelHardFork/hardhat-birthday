...
contract Birthday {
    ...
    function getPresent() public onlyRecipient afterDayD {
        require(address(this).balance != 0, "Birthday: Sorry, nobody have done any contributions for your present..");
    ...
    function _deposit(uint256 amount) private {
        require(block.timestamp <= _birthdayDate, "Birthday: you cannot give present after the birthday is passed.");
    ...
    function _humanDateToEpochTime(
        uint256 year,
        uint256 month,
        uint256 day
